...
#TODO Cambiar el token constantemente (Línea 20)
#TODO Cambiaar la redirección constantemente (Línea 27)
#TODO NO SUBIR LOS PYCACHES
...
def token_required(f):
    ...
    def decorated_function(*args, **kwargs):
        ...
        if not token or token != TK:
            return redirect("https://www.youtube.com/watch?v=E4WlUXrJg4")
